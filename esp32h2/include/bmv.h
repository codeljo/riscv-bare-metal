...
/* set CPU clock frequency to 1, 2, 4, 8, 16, 32, 48, 96 MHz */
...
#define PWM_RESOLUTION_MAX  0x1F
#define PWM_DUTY_MAX        0x1FFFFFF
#define PWM_CLOCK_PLL_F96M  0
#define PWM_CLOCK_RCFAST    1
#define PWM_CLOCK_XTAL      2
